...
export class Info extends Component {
    ...
    async saveVisitorInfo() {
        try {
            ...
            if (this.state.name==="") {
                this.state.error=this.state.translations.nameRequired;
                return;
            } else if (this.state.phone_required==="required" && this.state.phone==="") {
                this.state.error=this.state.translations.phoneNumberRequired;
                return;
            } else if (this.state.organization_required==="required" && this.state.company==="") {
                this.state.error=this.state.translations.organizationRequired;
                return;
            }
